...
export function TriageInbox({ projectId, projectKey, issues: initialIssues, openStateId, closedStateId, components, members, canManage, aiConfigured = true }: Props) {
