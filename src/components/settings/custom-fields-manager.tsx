...
const tokenPresets = {
  read: ["projects:read", "issues:read", "milestones:read", "search:read"],
  contributor: ["projects:read", "issues:read", "issues:write", "comments:write", "milestones:read", "search:read"],
  full: ["projects:read", "issues:read", "issues:write", "comments:write", "milestones:read", "search:read"],
} as const;
