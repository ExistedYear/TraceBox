...
type Props = { projectId: string; initialTemplates: TemplateRow[] };
const types = ["BUG", "ENHANCEMENT", "TASK", "SECURITY", "PERFORMANCE", "REGRESSION"];

export function IssueTemplatesManager({ projectId, initialTemplates }: Props) {
