...
`supabase/migrations/` holds thirty-eight ordered migrations through Phase 20, including foundational schema/RLS/RPC hardening, collaboration/planning, notifications/realtime, search/saved views, issue links, triage, attachments/storage policies, templates, restricted issue access, GitHub integrations/webhooks, custom fields/API tokens, notification guards, and final audit corrections. The consolidated `supabase/full_schema.sql` contains the same 38 migrations in order.
