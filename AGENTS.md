...
- **Demo seed**: `supabase/seed.sql` creates the intentional public local/demo login `demo@123.com` / `demo123` with a realistic public workspace. Never run the seed against a production tenant or treat these public credentials as a secret.
