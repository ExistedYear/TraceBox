...
This plan converts the findings from `docs/incomplete.md` and the now-retired historical `docs/incomplete_v2.md` into a dependency-safe implementation sequence. A feature is complete only when users can discover, configure, execute, recover from failure, and observe it through an authorized product workflow.

The audits overlapped. Phase 0 consolidated their findings into the authoritative `docs/incomplete.md` and retired `docs/incomplete_v2.md`. Source implementation, automated verification, and external deployment validation remain separate completion states.
...
Status: source-complete on 2026-08-28. `docs/incomplete_v2.md` was retired after its unique findings were preserved in `docs/incomplete.md`.
...
- Merge unique findings from `docs/incomplete_v2.md`, including:
  ...
  - historical status of `docs/plan.md`.
...
- Retire `docs/incomplete_v2.md` only after all unique content is represented in the authoritative tracker.
...
- Mark `docs/plan.md` as historical foundation guidance; use `docs/deployment.md` and `handoff.md` for current operations.
